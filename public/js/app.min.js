(() => {
            ...
            if (i)
                if (
                    ...
                    if (this.youTubeCode) {
                        ...
                        const s = this.options.setAutoplayYoutube
                            ? "autoplay;"
                            : "";
                        if (
    ...
    let l = (e, t = !1, s = 500, i = 0) => {
        ...
        if (n) {
            ...
            o(`[gotoBlock]: Юхуу...їдемо до ${e}`);
        } else o(`[gotoBlock]: Йой... Такого блоку немає на сторінці: ${e}`);
    };
    let d = {
        getErrors(e) {
            let t = 0,
                ...
                for (let t = 0, i = s.length; t < i; t += 1) {
                    ...
                    void 0 !== n &&
                        ...
                        (b(e[i]) && b(r[i])
                            ...
                            : !b(e[i]) && b(r[i])
                            ? ((e[i] = {}),
                              r[i].__swiper__ ? (e[i] = r[i]) : y(e[i], r[i]))
                            : (e[i] = r[i]));
                }
            }
        }
    ...
    var V = {
        ...
        updateSlides: function () {
            ...
            if (
                ...
                L && e.grid.updateWrapperSize(A, u),
                !s.centeredSlides)
            ) {
                const t = [];
        ...
        slideTo: function (e, t, s, i, r) {
            ...
            if (
                ...
                return (
                    ...
                    "slide" !== a.effect && n.setTranslate(g),
                    "reset" !== w &&
    ...
    function Y(e) {
        ...
        if (
            s.params.threshold &&
            Math.sqrt(u ** 2 + m ** 2) < s.params.threshold
        )
            return;
    ...
    function X(e) {
        ...
        if (p > n.longSwipesMs) {
            ...
            "next" === t.swipeDirection &&
                (y >= n.longSwipesRatio
                    ? t.slideTo(n.rewind && t.isEnd ? w : m + S)
                    : t.slideTo(m)),
            ...
            breakpoints: {
                setBreakpoint: function () {
                    ...
                    const p = a.direction && a.direction !== i.direction,
                        u =
                            i.loop &&
                            (a.slidesPerView !== i.slidesPerView || p),
                        h = i.loop;
                    p && s && e.changeDirection(), y(e.params, a);
    ...
    Object.keys(re).forEach((e) => {
        ...
        window.addEventListener("load", function (e) {
            document.querySelector(".swiper-media") &&
                new oe(".swiper-media", {
                    modules: [ae],
                    observer: !0,
                    observeParents: !0,
                ...
                document.querySelector(".swiper-blog") &&
                    new oe(".swiper-blog", {
                        modules: [ae],
                        observer: !0,
                        observeParents: !0,
    ...
    setTimeout(() => {
        ...
        document.addEventListener("DOMContentLoaded", function () {
                ...
                t.length &&
                    (t.forEach((t) => {
                        t.addEventListener("click", (s) => {
                            s.stopPropagation(),
                                t.classList.contains("dropdown-open")
                                    ? t.classList.remove("dropdown-open")
                                    : (e(), t.classList.add("dropdown-open"));
                        });
                    }),
                    document.addEventListener("click", (t) => {
                        t.target.closest(".dropdown") || e();
                    }));
            }
            function e() {
            ...
            function t(e) {
                const t = e.currentTarget,
                    s = t.querySelector(".rate-exchange__input"),
                    i = t.querySelector(".rate-exchange__description"),
                    r = t.querySelector(" .rate-exchange__safe img"),
                    n = "true" === t.dataset.locked;
                (s.textContent = n ? "lock" : "unlock"),
                    (t.dataset.locked = !n),
                    t.classList.toggle("rotate"),
                    (r.src = n
                        ? "./img/change/unlock.svg"
                        : "./img/change/locked.svg"),
                    (i.textContent = n ? "Floating rate" : "Fixed rate");
            }
            //! form pages test
            // document.querySelectorAll(".rate-exchange").forEach((e) => {
            //     e.addEventListener("click", t);
            // });
            // const s = document.querySelector("form");
            // if (s) {
            //     const e = s.getAttribute("data-page-address");
            ...
            // }
            //!custom select
            const i = document.querySelectorAll(".select");
            i.length &&
                i.forEach((e) => {
                    const t = e.querySelector(".select__button"),
                        s = e.querySelector(".select__search-close");
                    ...
                    let i = new (class {
                            ...
                            onInputChange() {
                                const e = new CustomEvent("searchEmployee", {
                                    detail: { findText: this.input.value },
                                });
                        ...
                        r = new (class {
                            sortList(t) {
                                e.querySelectorAll(".option__item").forEach(
                                    (e) => {
                                        e.textContent
                                            .toLowerCase()
                                            .trim()
                    ...
                    i.input.addEventListener("searchEmployee", function (e) {
                        r.sortList(e.detail.findText);
                    });
                    new (class {
                        constructor() {
                            (this.optionItems =
                                e.querySelectorAll(".option__item")),
                                (this.selectLabel =
                                    e.querySelector(".select__button1")),
                                (this.selectWrapper =
                        ...
                        attachEvents() {
                            this.optionItems.forEach((e) => {
                                e.addEventListener("click", () => {
                                    this.updateSelectLabel(e),
                        ...
                        updateSelectLabel(e) {
                            const t = e
                                    ...
                                    .textContent.trim(),
                                s = e
                                    .querySelector(".option__icon img")
                                    .getAttribute("src"),
                                i = e
                                    .querySelector(".option__icon img")
                                    .getAttribute("alt");
                            (this.selectLabel.innerHTML = `\n          <div class="select__icon">\n            <img src="${s}" alt="${i}">\n          </div>\n          <input class="select__value" value="${t}" placeholder="${t}" type="text" name="select1">\n        `),
                    ...
                    new (class {
                        constructor() {
                            (this.optionItems =
                                e.querySelectorAll(".option__item")),
                                (this.selectLabel =
                                    e.querySelector(".select__button2")),
                                (this.selectWrapper =
                                    e.querySelector(".select__wrapper")),
                                (this.select = e),
                                this.attachEvents();
                        ...
                        updateSelectLabel(e) {
                            const t = e
                                ...
                                i = e
                                    .querySelector(".option__icon img")
                                    .getAttribute("alt");
                            (this.selectLabel.innerHTML = `\n          <div class="select__icon">\n            <img src="${s}" alt="${i}">\n          </div>\n          <input class="select__value" value="${t}" placeholder="${t}" type="text" name="select2">\n        `),
                                (this.select.querySelector(
                                    ".select__value"
                                ).value = t);
                        }
                    ...
                    new (class {
                        constructor() {
                            (this.optionItems =
                                e.querySelectorAll(".option__item")),
                                (this.selectLabel =
                                    e.querySelector(".select__button3")),
                                (this.selectWrapper =
                                    e.querySelector(".select__wrapper")),
                                (this.select = e),
                                this.attachEvents();
                        ...
                        updateSelectLabel(e) {
                            const t = e
                                ...
                                i = e
                                    .querySelector(".option__icon img")
                                    .getAttribute("alt");
                            (this.selectLabel.innerHTML = `\n          <div class="select__icon">\n            <img src="${s}" alt="${i}">\n          </div>\n          <input class="select__value" value="${t}" placeholder="${t}" type="text" name="select3">\n        `),
                                (this.select.querySelector(
                                    ".select__value"
                                ).value = t);
                        }
                    ...
                    new (class {
                        constructor() {
                            (this.optionItems =
                                e.querySelectorAll(".option__item")),
                                (this.selectLabel =
                                    e.querySelector(".select__button4")),
                                (this.selectWrapper =
                                    e.querySelector(".select__wrapper")),
                                (this.select = e),
                                this.attachEvents();
                        ...
                        updateSelectLabel(e) {
                            const t = e
                                ...
                                i = e
                                    .querySelector(".option__icon img")
                                    .getAttribute("alt");
                            (this.selectLabel.innerHTML = `\n          <div class="select__icon">\n            <img src="${s}" alt="${i}">\n          </div>\n          <input class="select__value" value="${t}" placeholder="${t}" type="text" name="select4">\n        `),
                                (this.select.querySelector(
                                    ".select__value"
                                ).value = t);
                        }
            ...
            if (e.length > 0) {
                ...
                function n(e, t = !1) {
                    e.forEach((e) => {
                        (e = t ? e.item : e),
                            t.matches || !t
                                ? (e.classList.add("_spoller-init"), o(e))
                            ...
                            t
                                ? (s.removeAttribute("tabindex"),
                                  e.hasAttribute("data-open")
                                      ? (s.classList.add("_spoller-active"),
                                        (e.open = !0))
                                      : ((e.open = !1),
                                        (s.nextElementSibling.hidden = !0)))
                        ...
                        s(e, Math.min(t, i)),
                            e.addEventListener("input", () => {
                                e.scrollHeight > t &&
                                    ...
                                    s(
                                        e,
                                        Math.min(Math.max(e.scrollHeight, t), i)
                                    ));
                            });
                    });
                }
        ...
        //         if (
        //             0 ===
        //             (e.hasAttribute("data-no-validate") ? 0 : d.getErrors(e))
        //         ) {
